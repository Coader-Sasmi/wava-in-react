    ...
    <div className="container-7 main-container">
        <div className="phones-right">
            ...
            <div className="phones-text">
                <h2>Describe Your
                    <span className="phones-text-bold">Best Feature</span> From <br/>The App
                </h2>
                <p className="phones-right-p">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
                    dolore
